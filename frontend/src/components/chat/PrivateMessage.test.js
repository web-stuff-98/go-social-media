...
describe("private message component", () => {
  test("renders the message content", () => {
    render(<PrivateMessage msg={mockMessage} reverse={false} />, container);
  ...
  test("renders the message in reverse", () => {
    render(<PrivateMessage msg={mockMessage} reverse={true} />, container);
